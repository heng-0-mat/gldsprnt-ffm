...
class Highscore():
    ...
    def fill_item_surface(self):
        first = self.items_offset if self.items_offset > 0 else 0
        last = len(self.sorted_results) if self.items_offset > len(self.sorted_results) else self.items_offset + 10
